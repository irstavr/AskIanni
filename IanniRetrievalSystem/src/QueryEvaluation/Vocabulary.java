...
public class Vocabulary {	
	...
	public void setVocabulary(String vocabularyFileName) throws IOException {
		...
		// Reading from file
		try {
			BufferedReader file = new BufferedReader(new InputStreamReader(new FileInputStream(vocabularyFileName), "UTF8"));
			...
			for (String line; (line = file.readLine()) != null;) {
				...
				addToVocabulary(term, 
								Long.parseLong(lineStrings[1]),
	...
	public void setStopWords(HashMap<String, Integer> stopWords) {
		Vocabulary.stopWords = stopWords;
	}	
}
